...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    state4.connectors = connectors;
  },
  addConnector(connector) {
    state4.connectors.push(connector);
  },
  removeConnectorById(connectorId) {
    state4.connectors = state4.connectors.filter((c) => c.id !== connectorId);
  }
};
...
var ApiController = {
  ...
  setSdkVersion(sdkVersion) {
    state8.sdkVersion = sdkVersion;
  },
  _getApiHeaders() {
    return {
      "x-project-id": OptionsController.state.projectId,
      "x-sdk-type": sdkType,
      "x-sdk-version": state8.sdkVersion
    };
  },
...
var ConnectionController = {
  ...
  connectWalletConnect() {
    state11.wcPromise = this._getClient().connectWalletConnect((uri) => {
      state11.wcUri = uri;
      state11.wcPairingExpiry = CoreHelperUtil.getPairingExpiry();
    });
  },
  async connectExternal(id) {
    var _a, _b;
    await ((_b = (_a = this._getClient()).connectExternal) == null ? void 0 : _b.call(_a, id));
  },
  checkInjectedInstalled(ids) {
    var _a, _b;
    return (_b = (_a = this._getClient()).checkInjectedInstalled) == null ? void 0 : _b.call(_a, ids);
  },
  resetWcConnection() {
    state11.wcUri = void 0;
    state11.wcPairingExpiry = void 0;
    state11.wcPromise = void 0;
    state11.wcLinking = void 0;
    state11.recentWallet = void 0;
    StorageUtil.deleteWalletConnectDeepLink();
  },
  setWcLinking(wcLinking) {
    state11.wcLinking = wcLinking;
  },
  setWcError(wcError) {
    state11.wcError = wcError;
    state11.buffering = false;
  },
  setRecentWallet(wallet) {
    state11.recentWallet = wallet;
  },
  setBuffering(buffering) {
    state11.buffering = buffering;
  },
  async disconnect() {
...
use-sync-external-store/cjs/use-sync-external-store-shim.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-U3GPFHTE.js.map
