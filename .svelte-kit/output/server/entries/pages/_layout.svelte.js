...
import { L as LinkButton } from "../../chunks/LinkButton.js";
...
const css = {
  code: ".logo.svelte-kgv073{font-size:24px;color:#d0bcff;letter-spacing:0.2rem}",
  map: null
};
...
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return ` ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, { background: "bg-transparent" }, {}, {
        trail: () => {
          return `${validate_component(LinkButton, "LinkButton").$$render($$result, { name: "STUDIO", link: "studio" }, {}, {})} ${validate_component(LinkButton, "LinkButton").$$render($$result, { name: "MARKET", link: "market" }, {}, {})} <w3m-button label="Connect"></w3m-button> `;
        },
        lead: () => {
          return `${$page.url.pathname !== "/" ? `<strong class="logo svelte-kgv073" data-svelte-h="svelte-nasmab"><a href="/">INNOVATION STATION</a></strong>` : ``}`;
        }
      })} `;
    },
    default: () => {
