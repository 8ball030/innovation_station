...
"""
This module contains the support resources for the agent_identity protocol.
...
from packages.your_name.protocols.agent_identity.serialization import (
    AgentIdentitySerializer,
)


AgentIdentityMessage.serializer = AgentIdentitySerializer
