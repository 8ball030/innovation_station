...
class TaskStatus(Enum):
    """This class represents an instance of TaskStatus."""
    ...
    @staticmethod
    def encode(task_status_protobuf_object, task_status_object: "TaskStatus") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the task_status_protobuf_object argument is matched with the instance of this
        class in the 'task_status_object' argument.

        :param task_status_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param task_status_object: an instance of this class to be encoded in the protocol buffer object.
        """
        task_status_protobuf_object.task_status = task_status_object.value

    @classmethod
    def decode(cls, task_status_protobuf_object) -> "TaskStatus":
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the
        'task_status_protobuf_object' argument.

        :param task_status_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the
        'task_status_protobuf_object' argument.
        """
        return TaskStatus(task_status_protobuf_object.task_status)


CUSTOM_ENUM_MAP = {"<class 'todo_list_pb2.ErrorCode'>": ErrorCode, "<class 'todo_list_pb2.TaskStatus'>": TaskStatus}
