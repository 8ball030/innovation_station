...
"""
This module contains the support resources for the todo_list protocol.
...
from packages.your_name.protocols.todo_list.serialization import TodoListSerializer


TodoListMessage.serializer = TodoListSerializer
