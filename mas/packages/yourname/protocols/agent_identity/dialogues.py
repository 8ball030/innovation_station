...
class AgentIdentityDialogue(Dialogue):
    ...
    INITIAL_PERFORMATIVES: FrozenSet[Message.Performative] = frozenset(
        {AgentIdentityMessage.Performative.SET_IDENTITY, AgentIdentityMessage.Performative.GET_IDENTITY}
    )
    TERMINAL_PERFORMATIVES: FrozenSet[Message.Performative] = frozenset(
        {AgentIdentityMessage.Performative.IDENTITY_RESPONSE, AgentIdentityMessage.Performative.ERROR}
    )
    VALID_REPLIES: Dict[Message.Performative, FrozenSet[Message.Performative]] = {
        AgentIdentityMessage.Performative.ERROR: frozenset(),
        AgentIdentityMessage.Performative.GET_IDENTITY: frozenset(
            {AgentIdentityMessage.Performative.IDENTITY_RESPONSE, AgentIdentityMessage.Performative.ERROR}
        ),
        AgentIdentityMessage.Performative.IDENTITY_RESPONSE: frozenset(),
        AgentIdentityMessage.Performative.SET_IDENTITY: frozenset(
            {AgentIdentityMessage.Performative.IDENTITY_RESPONSE, AgentIdentityMessage.Performative.ERROR}
        ),
    }
...
class AgentIdentityDialogues(Dialogues, ABC):
    ...
    END_STATES = frozenset({AgentIdentityDialogue.EndState.IDENTITY_RESPONSE, AgentIdentityDialogue.EndState.ERROR})
