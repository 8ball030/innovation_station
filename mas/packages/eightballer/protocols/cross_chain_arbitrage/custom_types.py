...
class RejectionReason(Enum):
    """This class represents an instance of RejectionReason."""
    ...
    @staticmethod
    def encode(rejection_reason_protobuf_object, rejection_reason_object: "RejectionReason") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the rejection_reason_protobuf_object argument is matched with the instance of this
        class in the 'rejection_reason_object' argument.

        :param rejection_reason_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param rejection_reason_object: an instance of this class to be encoded in the protocol buffer object.
        """
        rejection_reason_protobuf_object.rejection_reason = rejection_reason_object.value

    @classmethod
    def decode(cls, rejection_reason_protobuf_object) -> "RejectionReason":
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the
        'rejection_reason_protobuf_object' argument.

        :param rejection_reason_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the
        'rejection_reason_protobuf_object' argument.
        """
        return RejectionReason(rejection_reason_protobuf_object.rejection_reason)


CUSTOM_ENUM_MAP = {
    "<class 'cross_chain_arbitrage_pb2.RejectionReason'>": RejectionReason,
    "<class 'cross_chain_arbitrage_pb2.ErrorCode'>": ErrorCode,
}
