...
class OperationType(Enum):
    """This class represents an instance of OperationType."""
    ...
    @staticmethod
    def encode(operation_type_protobuf_object, operation_type_object: "OperationType") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the operation_type_protobuf_object argument is matched with the instance of this
        class in the 'operation_type_object' argument.

        :param operation_type_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param operation_type_object: an instance of this class to be encoded in the protocol buffer object.
        """
        operation_type_protobuf_object.operation_type = operation_type_object.value

    @classmethod
    def decode(cls, operation_type_protobuf_object) -> "OperationType":
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the
        'operation_type_protobuf_object' argument.

        :param operation_type_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the
        'operation_type_protobuf_object' argument.
        """
        return OperationType(operation_type_protobuf_object.operation_type)
...
CUSTOM_ENUM_MAP = {
    "<class 'hackathon_journey_pb2.OperationType'>": OperationType,
    "<class 'hackathon_journey_pb2.Status'>": Status,
    "<class 'hackathon_journey_pb2.ErrorCode'>": ErrorCode,
}
