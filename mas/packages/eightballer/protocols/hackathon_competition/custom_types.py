...
CUSTOM_ENUM_MAP = {
    "<class 'hackathon_competition_pb2.Status'>": Status,
    "<class 'hackathon_competition_pb2.SubmissionType'>": SubmissionType,
    "<class 'hackathon_competition_pb2.ErrorCode'>": ErrorCode,
}
