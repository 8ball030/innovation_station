...
class SubmissionStatus(Enum):
    """This class represents an instance of SubmissionStatus."""
    ...
    @staticmethod
    def encode(submission_status_protobuf_object, submission_status_object: "SubmissionStatus") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the submission_status_protobuf_object argument is matched with the instance of
        this class in the 'submission_status_object' argument.

        :param submission_status_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param submission_status_object: an instance of this class to be encoded in the protocol buffer object.
        """
        submission_status_protobuf_object.submission_status = submission_status_object.value

    @classmethod
    def decode(cls, submission_status_protobuf_object) -> "SubmissionStatus":
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the
        'submission_status_protobuf_object' argument.

        :param submission_status_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the
        'submission_status_protobuf_object' argument.
        """
        return SubmissionStatus(submission_status_protobuf_object.submission_status)


class SubmissionType(Enum):
    """This class represents an instance of SubmissionType."""
    ...
    @staticmethod
    def encode(submission_type_protobuf_object, submission_type_object: "SubmissionType") -> None:
        """
        Encode an instance of this class into the protocol buffer object.

        The protocol buffer object in the submission_type_protobuf_object argument is matched with the instance of this
        class in the 'submission_type_object' argument.

        :param submission_type_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :param submission_type_object: an instance of this class to be encoded in the protocol buffer object.
        """
        submission_type_protobuf_object.submission_type = submission_type_object.value

    @classmethod
    def decode(cls, submission_type_protobuf_object) -> "SubmissionType":
        """
        Decode a protocol buffer object that corresponds with this class into an instance of this class.

        A new instance of this class is created that matches the protocol buffer object in the
        'submission_type_protobuf_object' argument.

        :param submission_type_protobuf_object: the protocol buffer object whose type corresponds with this class.
        :return: A new instance of this class that matches the protocol buffer object in the
        'submission_type_protobuf_object' argument.
        """
        return SubmissionType(submission_type_protobuf_object.submission_type)


CUSTOM_ENUM_MAP = {
    "<class 'hackathon_process_pb2.ErrorCode'>": ErrorCode,
    "<class 'hackathon_process_pb2.SubmissionType'>": SubmissionType,
    "<class 'hackathon_process_pb2.SubmissionStatus'>": SubmissionStatus,
}
