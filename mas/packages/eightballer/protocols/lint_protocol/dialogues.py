...
class LintProtocolDialogue(Dialogue):
    ...
    TERMINAL_PERFORMATIVES: FrozenSet[Message.Performative] = frozenset(
        {LintProtocolMessage.Performative.LINT_COMPLETED, LintProtocolMessage.Performative.ERROR}
    )
    VALID_REPLIES: Dict[Message.Performative, FrozenSet[Message.Performative]] = {
        LintProtocolMessage.Performative.ERROR: frozenset(),
        LintProtocolMessage.Performative.INITIATE_LINT: frozenset(
            {
                LintProtocolMessage.Performative.LINT_ISSUE,
                LintProtocolMessage.Performative.LINT_COMPLETED,
                LintProtocolMessage.Performative.ERROR,
            }
        ),
        LintProtocolMessage.Performative.LINT_COMPLETED: frozenset(),
...
class LintProtocolDialogues(Dialogues, ABC):
    ...
    END_STATES = frozenset({LintProtocolDialogue.EndState.LINT_COMPLETED, LintProtocolDialogue.EndState.ERROR})
