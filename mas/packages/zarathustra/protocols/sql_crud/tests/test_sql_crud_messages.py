...
class TestMessageSqlCrud(BaseProtocolMessagesTestCase):
    ...
    def build_messages(self) -> List[SqlCrudMessage]:  # type: ignore[override]
        ...
        return [
            SqlCrudMessage(
                performative=SqlCrudMessage.Performative.CREATE,
                table_name="some str",
                data={"some str": b"some_bytes"},
            ),
            SqlCrudMessage(
                performative=SqlCrudMessage.Performative.READ,
                table_name="some str",
                condition="some str",
            ),
            SqlCrudMessage(
            ...
            SqlCrudMessage(
                performative=SqlCrudMessage.Performative.END,
            ),
        ]
